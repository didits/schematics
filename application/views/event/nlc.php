	...
	<div class="box">
		<div class="s-12 l-8 center wow fadeInRight">
			...
			<form class="customform" action="<?php echo base_url();?>nlc/quiz" method="post">
				<br>
				<div class="s-12 l-4">
					<button type="submit">Contoh Soal NLC</button>
				</div>
				<br>
				<br>
			</form>
			...
			<ol type="A">
				<li>
					...
					<ol type="1">
						...
						<ul style="list-style-type:none">
							<li style="list-style-type:square">Rp. 150.000,-/tim</li>
						</ul>
					</ol>
					<br>
					<div class="pemisah"></div>
		...
		<div align="center" >
			...
			<div class="s-12 l-2">
				...
				<section class="wow fadeIn" data-wow-duration="3s" data-wow-delay="10s" data-wow-offset="12"  data-wow-iteration="15">
					...
					<p style="list-style-type:square">Semua juara akan mendapatkan sertifikat dan plakat juara dan hadiah uang.</li>
				<p style="list-style-type:square; font-style:italic">*Diterima di Teknik Informatika ITS reguler melalui jalur SNMPTN / double degree (Korea, Belanda, Australia) berlaku peserta yang duduk di kelas 12 saat lomba berlangsung dan lulus UNAS.</p>
				</li>
				<br>
				<div class="pemisah"></div>
				<br>
				<li>
					...
					<ol type="1">
						<li>
							<p>Pendaftaran: 1 juli - 12 september 2015</p>
						</li>
						</ul>
						<li>
						...
						<ul style="list-style-type:none">
							<li style="list-style-type:square">90 tim terbaik dari babak penyisihan berhak mengikuti babak perempat final.</li>
							...
							<li style="list-style-type:square">Fasilitas Perempat Final: Kaos + Makan + Transport gratis</li>
						</ul>
						<li>
							<p>11 oktober 2015</p>
						</li>
			...
			<form class="customform" action="<?php base_url(); ?>buat_akun?">
				...
				<div class="s-12 l-3 center">
					<button type="submit" style="background-color:#06F" name="event" value="nlc">Daftar NLC</button>
				</div>
			</form>
		</div>
	</div>
...
<br>
<div class="pemisah"></div>
<h1 align="center">TIMELINE NLC</h1>
<br>
<!--di sini timeline-->
